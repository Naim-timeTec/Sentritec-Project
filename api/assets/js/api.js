/* Sentritec API Documentation — standalone site assets.
   Generates a placeholder page for every sidebar item, drives the
   page switcher, the "on this page" rail and the sidebar search.
...
(function () {
  ...
  /* build a placeholder page for every sidebar item that doesn't have one yet */
  links.forEach(function (l) {
    ...
    sec.innerHTML =
      ...
      "<span>This section is being written as part of our beta testing program and will be published with the public API launch in October 2026.</span>" +
      "</div>" +
      ...
      '<section class="apid-sec"><h3>Request &amp; Response</h3>' +
      '<div class="apid-skel" aria-hidden="true"><span></span><span></span><span></span><span></span></div></section>' +
      '<section class="apid-sec"><h3>Reference</h3>' +
      '<div class="apid-skel" aria-hidden="true"><span></span><span></span><span></span><span></span></div></section>';
  ...
  /* ---------- "On this page" mini-TOC (right rail) ---------- */
  ...
  /* deep-link support: /api#quick-start-guide opens that page */
  ...
  /* sidebar search — filters the nav items as you type (CTRL-/ focuses it) */
